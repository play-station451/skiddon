...
import com.skid.addon.utils.StashHuntingUtils;
import com.skid.addon.modules.Pitch40Util;
...
import static com.skid.addon.utils.StashHuntingUtils.positionInDirection;
import static com.skid.addon.utils.StashHuntingUtils.sendWebhook;
...
public class TrailFollower extends Module
{
    ...
    {
        super(Skiddon.CATEGORY, "TrailFollower", "Automatically follows trails in all dimensions.");
    }
...
//                    }
            ...
            case YAWLOCK: {
                mc.player.setYaw(StashHuntingUtils.smoothRotation(getActualYaw(mc.player.getYaw()), targetYaw, rotateScaling.get()));
                break;
            }
        }
...
//                log("ChunkPos: " + chunkPos.x + ", " + chunkPos.z);
        ...
        double angleDiff = StashHuntingUtils.angleDifference(targetYaw, chunkAngle);
