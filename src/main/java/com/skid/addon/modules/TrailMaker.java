...
public class TrailMaker extends Module
{
    ...
    public TrailMaker()
    {
        super(Skiddon.CATEGORY, "trail-maker", "Allows you to plot xaero chunk highlights on the map and then follow them in order.");
    }
    ...
    private void onTick(TickEvent.Pre event)
    {
        ...
        if (following)
        {
            ...
            mc.player.setYaw(StashHuntingUtils.smoothRotation(mc.player.getYaw(), targetYaw, rotationScaling.get()));
