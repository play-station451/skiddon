...
public class AutoLavaCaster extends Module {
    ...
    public AutoLavaCaster() {
        super(Skiddon.CATEGORY, "AutoLavaCaster", "Make Layers of Cobble on your Stairs! Aim at the top of the block you want to lava on.");
    }
    ...
    private void pickupLiquid() {
        ...
        int prevSlot = mc.player.getInventory().getSelectedSlot();
        int bucketSlot = findItemResult.slot();
